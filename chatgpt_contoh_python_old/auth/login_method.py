...
from chatgpt_contoh_python_old.auth.otp_auth.otp_auth import OTPAuth
...
class LoginMethod(ABC):
    ...
    def derive_login_provider(account: dict):
        ...
        from chatgpt_contoh_python_old.auth.methods.basic_login import BasicLogin
        from chatgpt_contoh_python_old.auth.methods.google_login import GoogleLogin
